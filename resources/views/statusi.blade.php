                ...
                @foreach ($statusi as $status)
                        <tr>
                                ...
                                <td>{{$status->napomena}}</td>
                                 ...
                                 <a class="btn btn-success btn-sm otvori_izmenu" id="dugmeIzmena"  href="{{ route('statusi.pregled', $status->id) }}"><i class="fa fa-eye"></i></a>
...
<hr>
<div class="well">
    <form action="{{ route('statusi.dodavanje') }}" method="POST">
        {{ csrf_field() }}
