                ...
                @foreach ($referenti as $referent)
                        <tr>
                                ...
                                <td>{{$referent->napomena}}</td>
                                 ...
                                 <a class="btn btn-success btn-sm otvori_izmenu" id="dugmeIzmena"  href="{{ route('referenti.pregled', $referent->id) }}"><i class="fa fa-eye"></i></a>
...
<hr>
<div class="well">
    <form action="{{ route('referenti.dodavanje') }}" method="POST">
        {{ csrf_field() }}
