...
@section('naslov')
    ...
    <div class="well">
    <form action="{{ route('vrste_predmeta.izmena',  $vrsta_predmeta->id) }}" method="POST">
        {{ csrf_field() }}
        ...
        <div class="form-group{{ $errors->has('napomena') ? ' has-error' : '' }}">
            ...
            <input type="text" name="napomena" id="napomena" class="form-control" value="{{ old('napomena', $vrsta_predmeta->napomena) }}">
        ...
        <div class="form-group text-right" style="margin-top: 20px">
            ...
            <a class="btn btn-danger" href="{{route('vrste_predmeta')}}"><i class="fa fa-ban"></i> Откажи измене</a>
        </div>
    </form>
</div>
@endsection