...
<div class="row ne_stampaj">
    <div class="col-md-6">
        <h1>
            <img class="slicica_animirana" alt="календар рочишта" src="{{url('/images/kalendar.png')}}" style="height:64px">
             Календарски преглед <strong class="text-success">рокова</strong>
        </h1>
    </div>
    ...
    <div class="col-md-2 text-right" style="padding-top: 40px;">
        <a class="btn btn-primary btn-block ono" href="{{ route('rokovi.dodavanje.get') }}"><i class="fa fa-plus-circle fa-fw"></i>&emsp;Додај рок
        </a>
    </div>
    <div class="col-md-2 text-right" style="padding-top: 40px;">
        <a class="btn btn-success btn-block ono" href="{{ route('rokovi') }}"><i class="fa fa-table fa-fw"></i>&emsp;Табеларни приказ</a>
    </div>
</div>
<hr>
<div id="pretraga_div" class="well" style="display: none;">
    <form id="pretraga" action="{{ route('rokovi.kalendar.filter.post') }}" method="POST">
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="form-group col-md-6 text-right ceo_dva">
                <div class="col-md-6 snimi">
                    <button type="submit" id="dugme_pretrazi" class="btn btn-success btn-block"><i class="fa fa-filter"></i>&emsp;Примени филтер</button>
                                ...
                                <div class="col-md-6">
                    <a class="btn btn-info btn-block" href="{{ route('rokovi.kalendar') }}"><i class="fa fa-ban"></i>&emsp;Откажи</a>
                </div>
            </div>
        </div>
    </form>
