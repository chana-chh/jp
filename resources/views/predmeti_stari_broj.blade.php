...
@section('naziv', 'Предмети | Стари бројеви')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <img class="slicica_animirana" alt="... стари бројеви"
                 src="{{url('/images/predmeti.png')}}" style="height:64px;">
            &emsp;Стари бројеви предмета <small class="text-success"><em>({{$predmet->broj()}})</em></small>
        </h1>
    </div>
...
@section('sadrzaj')
  @if($stari_brojevi->isEmpty())
            <h3 class="text-danger">Овај предмет нема старе бројеве</h3>
        @else
    ...
    <div class = "modal-dialog">
        <div class = "modal-content">
            ...
            <div class = "modal-body">
                <h3>Да ли желите трајно да уклоните стари број предмета? *</h3>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title text-primary">Измени стари број предмета</h2>
            </div>
            <div class="modal-body">
                <form action="{{ route('predmeti.stari_broj.izmena') }}" method="post">
                    {{ csrf_field() }}
...
<hr>
<div class="well">
    <form action="{{route('predmeti.stari_broj.dodavanje', $predmet->id)}}" method="POST" data-parsley-validate>
        {{ csrf_field() }}

        <div class="form-group{{ $errors->has('broj') ? ' has-error' : '' }}">
            <label for="broj">Стари број: </label>
...
$( document ).ready(function() {
    ...
    function resizeChosen() {
        ...
        $(document).on('click', '.otvori-brisanje', function () {
            var id = $(this).val();
            $('#idBrisanje').val(id);
            var ruta = "{{ route('predmeti.stari_broj.brisanje') }}";
            console.log(ruta);
            console.log(id);
        ...
        var id = $(this).val();
        var ruta = "{{ route('predmeti.stari_broj.detalj') }}";
